...
Current release **0.11.2**. The full API — 129 public functions, and the six
...
an API reference as of **v0.11.0**; audited and hardened as of **v0.11.1**; optimized as of **v0.11.2**.
...
for t in geom flatten fill blit rotate gradient grow stroke clip aa draw present blend alloc \
         ...
         present_open inline_points transform pattern present_geom harden; do
